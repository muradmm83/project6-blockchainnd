App = {
    ...
    handleButtonClick: async function (event) {
        ...
        switch (processId) {
            case 1:
                ...
                break;
            case 2:
                return await App.assembleItem(event);
                break;
            case 3:
    ...
    assembleItem: function (event) {
        event.preventDefault();
        var processId = parseInt($(event.target).data('id'));

        App.contracts.SupplyChain.deployed().then(function (instance) {
            return instance.assembleItem(App.upc, {
                from: App.metamaskAccountID
            });
        }).then(function (result) {
            $("#ftc-item").text(result);
            console.log('assembleItem', result);
        }).catch(function (err) {
            console.log(err.message);
        });
    },
    ...
    sellItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            ...
            return instance.sellItem(App.upc, productPrice /* App.productPrice */ , {
                from: App.metamaskAccountID
            });
        }).then(function (result) {
            $("#ftc-item").text(result);
    ...
    buyItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            ...
            return instance.buyItem(App.upc, {
                from: App.retailerID,// App.metamaskAccountID,
                value: walletValue
            });
        }).then(function (result) {
            $("#ftc-item").text(result);
